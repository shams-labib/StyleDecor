...
const Contact = () => {
  return (
    <section className="relative bg-gray-50 dark:bg-gray-900 py-20 px-6 overflow-hidden">
      {/* Background Glow */}
      <div className="absolute inset-0 bg-gradient-to-b from-primary/10 to-transparent blur-3xl opacity-70 pointer-events-none"></div>
